...
fun RunwayStripEntity.directionOptions(): List<RunwayDirectionOption> = listOf(
    RunwayDirectionOption(this, designatorA, headingDegTrueA, slopePctA),
    RunwayDirectionOption(this, designatorB, (headingDegTrueA + 180.0) % 360.0, -slopePctA)
)

fun RunwayDirectionOption.toCandidate(): RunwayCandidate = RunwayCandidate(designator, headingDegTrue, strip.lengthM, slopePct)
