 ...
 * [nl.schellenberg.hk36ttc.data.metar.MetarRepositoryTest]'s job to cover. This file only
 * tests what [MetarAutoRefresher] itself adds on top: the once-per-airfield-per-instance
 * bookkeeping — the exact thing that was missing on [nl.schellenberg.hk36ttc.ui.perf.LandingViewModel]
 * and [nl.schellenberg.hk36ttc.ui.perf.SleepvluchtViewModel] before this class existed.
 */
