package nl.schellenberg.hk36ttc.core.units
 ...
 * every other typed choice in this module (see [nl.schellenberg.hk36ttc.core.perf.TowBlockReason]) —
 ...
 * other to within floating-point rounding — see [nl.schellenberg.hk36ttc.core.units.UnitConversionsTest]
 * for the round-trip proof on every one of them.
 *
 * kt<->km/h reuses [nl.schellenberg.hk36ttc.core.metar.kmhToKts] rather than redefining the
 ...
 *
 * Deliberately plain data, with no Android dependency — [nl.schellenberg.hk36ttc.data.local.UnitPreferences]
