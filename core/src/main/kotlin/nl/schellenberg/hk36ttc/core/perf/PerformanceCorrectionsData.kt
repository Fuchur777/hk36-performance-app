...
data class PerformanceCorrectionsData(
     ...
     * [nl.schellenberg.hk36ttc.core.perf.PerformanceNormalData.Takeoff.grassRunwayPenaltyMinPct]
    ...
    companion object {
         ...
         * NOT used on the normal runtime path — see [nl.schellenberg.hk36ttc.core.wb.WbConstantsData.DEFAULT]
